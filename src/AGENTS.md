...
| `generated/jooq/` | jOOQ generated code for the current Flyway schema, including boards, drawings, sticker sharing, and nullable `analysis.failed_code`; id columns are generated as `global/identifier/` typed ids via `forcedType` converters. Never edit by hand; regenerate with `./gradlew flywayMigrate jooqCodegen` and commit |
