...
enum class AnalysisErrorCode(
    ...
    NO_STICKER_SUBJECT(HttpStatus.UNPROCESSABLE_ENTITY, "ANALYSIS-013", "스티커로 만들 대상을 찾지 못했습니다."),
    STICKER_GENERATION_FAILED(HttpStatus.BAD_GATEWAY, "ANALYSIS-014", "스티커를 생성하지 못했습니다."),
    RESULT_SAVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ANALYSIS-015", "분석 결과를 저장하지 못했습니다."),
    INTERNAL_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "ANALYSIS-016", "분석 처리 중 오류가 발생했습니다."),
    ANALYSIS_CANCELED(HttpStatus.CONFLICT, "ANALYSIS-017", "분석을 취소했습니다."),
    CLASSIFICATION_FAILED(HttpStatus.BAD_GATEWAY, "ANALYSIS-018", "사진 분석에 실패했습니다."),
}
