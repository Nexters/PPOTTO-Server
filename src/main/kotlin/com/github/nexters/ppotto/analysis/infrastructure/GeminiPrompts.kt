...
object GeminiPrompts {
    ...
    internal val COPY_VOICE =
        ...
        One exception to the voice: sticker.targetSubject is not copy. It is an instruction for an automated cutout tool and must stay plain, literal, and humorless.
        """.trimIndent()
