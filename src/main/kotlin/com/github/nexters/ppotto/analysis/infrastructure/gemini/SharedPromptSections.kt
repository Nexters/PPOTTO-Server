...
internal val STICKER_CANDIDATE_GUIDE =
    PromptSection(
...
internal val COPY_STYLE_EXAMPLES =
    PromptSection(
        "copy style examples",
        """
...
internal val OUTPUT_LANGUAGE = PromptSection("output language", "Write all text output in Korean.")
