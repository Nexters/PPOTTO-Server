...
enum class CommonErrorCode(
    ...
    UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "COMMON004", "인증이 필요합니다."),
    FORBIDDEN(HttpStatus.FORBIDDEN, "COMMON005", "접근 권한이 없습니다."),
    CONFLICT(HttpStatus.CONFLICT, "COMMON006", "이미 처리된 요청이거나 충돌이 발생했습니다."),
}
