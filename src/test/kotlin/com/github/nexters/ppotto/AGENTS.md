...
| `global/observability/SentryUserContextProviderTest.kt` | Sentry user context contract: UUID principal becomes `user.id` with no email/username/ip, while missing, anonymous, and non-UUID principals produce no user |
