...
| `support/UserTestFixtures.kt` | `UserRepository.saveTestUser()` extension that inserts a schema-valid Kakao test user; keeps test-only user creation out of the production repository |
