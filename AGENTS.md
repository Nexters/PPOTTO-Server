...
| `compose.production.yaml` | Production deployment overrides; mounts GCS credentials from `../secrets` and pins `SENTRY_ENVIRONMENT=production` with a 0.1 traces sample rate |
